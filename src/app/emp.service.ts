...
export class EmpService {
  ...
  delurl: String = 'https://5f0c803e.ngrok.io/api/Settings/DeleteDesignation?DesignationId=';
  editurl: string = 'https://5f0c803e.ngrok.io/api/Settings/InsUpdateDesignation';
