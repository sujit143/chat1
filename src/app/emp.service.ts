...
export class EmpService {
  ...
  delurl: String = "https://7b88bccc.ngrok.io/api/Settings/DeleteDesignation?DesignationId="
  editurl:string="https://7b88bccc.ngrok.io/api/Settings/InsUpdateDesignation"
